                    ...
                    <div class="single-products">
                        ...
                        <div class="product-overlay">
                            <div class="overlay-content">
                                <h2>{{$product->product_price}} Tk</h2>
                                <p>{{$product->product_name}}</p>
                                <a href="{{URL::to('/view-single-product/'.$product->product_id)}}" class="btn btn-default add-to-cart"><i class="fa fa-shopping-cart"></i>Add to cart</a>
                            </div>
                        </div>
                    </div>
                    <div class="choose">
                        <ul class="nav nav-pills nav-justified">
                            ...
                            <li><a href="{{URL::to('/view-single-product/'.$product->product_id)}}"><i class="fa fa-eye"></i>View Product</a></li>
                        </ul>
                    </div>
                </div>
            </div>
